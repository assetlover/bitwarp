...
const imagePath =
  "/media/aditya/Data/learning coding/pbl6/BitWarpReactComponents/reactComponents/src/images/pexels-markus-spiske-1089438.jpg";
  ...
  return (
    <div className="bg-cover bg-center h-screen bg-[url('https://images.pexels.com/photos/1089438/pexels-photo-1089438.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] min-h-screen min-w-screen flex flex-row items-center justify-center h-screen">
      <div className={cardcss}>
        ...
        />
        <button className="mt-10 p-2 bg-zinc-500 text-white text-2xl font-semibold  mt-5 rounded   w-full hover:bg-white hover:text-black duration-300 transition:ease ">
          Sign Up
        </button>
